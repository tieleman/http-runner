...
exports.spawn = function(process, args, notifyCallback, callback) {
  var argsArray = args.replace(/\s+/g, " ").split(' ');
  var theProcess = childProcess.spawn(process, argsArray);          
  var job = { stderr: '', stdout: '', id: generateId(), code: null, command: process, arguments: argsArray, callback: notifyCallback };
